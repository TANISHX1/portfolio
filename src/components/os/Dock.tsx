...
export function Dock({ onOpenApp, openApps, activeApp, isDragging }: DockProps) {
  const { theme } = useTheme();
  const isRice = theme === "rice";

  return (
    <div className={`fixed bottom-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 p-3 backdrop-blur-[24px] border transition-all duration-500 rounded-3xl shadow-2xl ${
      isRice 
